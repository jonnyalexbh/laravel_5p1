    ...
    <body>
        <div class="brand clearfix">
            ...
            <ul class="ts-profile-nav">
                ...
                <li class="ts-account">
                    <a href="#"><img src="{{asset('images/ts-avatar.jpg')}}" class="ts-avatar hidden-side" alt=""> Cuenta <i class="fa fa-angle-down hidden-side"></i></a>
                    <ul>
                        <li><a href="#">Mi cuenta</a></li>
                        <li><a href="#">Editar cuenta</a></li>
                        <li><a href="{{ route('home_destroy_path')}}">Cerrar sesión</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <div class="ts-main-content">
            <nav class="ts-sidebar">
                <ul class="ts-sidebar-menu">
                    ...
                    <li><a href="{{ route('home_destroy_path')}}"><i class="fa fa-sign-in" aria-hidden="true"></i> Cerrar sesión</a></li>
